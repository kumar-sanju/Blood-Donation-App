package com.smart.blooddonation.adapters;
...
import com.smart.blooddonation.Activity.StringCaseConverter;
import com.smart.blooddonation.listeners.MyOnClickListener;
import com.smart.blooddonation.model.User;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserHolder>{
    ...
    public UserHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new UserHolder(LayoutInflater.from(context).inflate(R.layout.all_doner_requests,parent,false));
    }
    ...
    static class UserHolder extends RecyclerView.ViewHolder{
        ...
        com.google.android.material.button.MaterialButton share,call;

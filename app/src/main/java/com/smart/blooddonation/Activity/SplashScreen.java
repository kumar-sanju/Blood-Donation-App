...
import com.smart.blooddonation.Register.RegisterIIActivity;
import com.smart.blooddonation.Register.RegisterIIIActivity;
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        switch (users.getStep()){
                            ...
                            case "2": startActivity(new Intent(SplashScreen.this, RegisterIIIActivity.class));
                                break;
                            case "Done": startActivity(new Intent(SplashScreen.this, HomeActivity.class));
                                break;
                        }
                        SplashScreen.this.finish();
                    }
